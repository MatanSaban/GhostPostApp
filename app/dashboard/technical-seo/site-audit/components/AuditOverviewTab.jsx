...
export default function AuditOverviewTab({
  ...
  function linkifyText(text) {
    ...
    return text.replace(urlRegex, (url) => {
      // Decode for readability (Hebrew/Arabic paths) while linking to the raw URL.
      const readable = decodeDisplayUrl(url);
      const display = readable.length > 60 ? readable.slice(0, 57) + '...' : readable;
