...
export default async function DashboardPage() {
  ...
  const translations = {
    ...
    // New: engagement quality + timeseries + actions
    aiEngagedSessions: t('dashboard.aiTraffic.engagedSessions'),
    aiEngagementRate: t('dashboard.aiTraffic.engagementRate'),
    aiAvgDuration: t('dashboard.aiTraffic.avgDuration'),
    aiKeyEvents: t('dashboard.aiTraffic.keyEvents'),
    tipAiEngagedSessions: t('dashboard.aiTraffic.tipEngagedSessions'),
    tipAiEngagementRate: t('dashboard.aiTraffic.tipEngagementRate'),
    tipAiAvgDuration: t('dashboard.aiTraffic.tipAvgDuration'),
    tipAiKeyEvents: t('dashboard.aiTraffic.tipKeyEvents'),
    aiTimeseriesTitle: t('dashboard.aiTraffic.timeseriesTitle'),
    aiOptimizeWithGhost: t('dashboard.aiTraffic.optimizeWithGhost'),
    aiOptimizeWithGhostHint: t('dashboard.aiTraffic.optimizeWithGhostHint'),
    aiClicks: t('dashboard.aiTraffic.clicks'),
    aiImpressions: t('dashboard.aiTraffic.impressions'),
    aiCtr: t('dashboard.aiTraffic.ctr'),
