...
export default async function ContentPlannerPage() {
  ...
  const viewTranslations = {
    ...
    campaigns: {
      ...
      clusterFilter: t('contentPlanner.campaigns.clusterFilter'),
      allClusters: t('contentPlanner.campaigns.allClusters'),
      noCampaignsInCluster: t('contentPlanner.campaigns.noCampaignsInCluster'),
      clearClusterFilter: t('contentPlanner.campaigns.clearClusterFilter'),
