...
// Status helpers
$status_labels = array(
    'connected'    => __('Connected', 'ghostseo-connector'),
    'disconnected' => __('Disconnected', 'ghostseo-connector'),
    'error'        => __('Connection Error', 'ghostseo-connector'),
);
$status_text = $status_labels[$status] ?? __('Unknown', 'ghostseo-connector');
?>
...
<div class="wrap gp-wrap gp-dashboard-page <?php echo esc_attr($theme_class); ?>" dir="<?php echo esc_attr($dir); ?>">
    ...
    ?>
    <div class="gp-header">
        <img src="<?php echo esc_url(GP_API_URL . $gp_logo_path); ?>" alt="GhostSEO" class="gp-header-wordmark">
    ...
    <div class="gp-status-hero gp-status-<?php echo esc_attr($status); ?>">
        ...
        <span class="gp-status-meta">
            <?php
            printf(
                esc_html__('Last ping %s ago', 'ghostseo-connector'),
    ...
    <div class="gp-card-grid">
        ...
        <div class="gp-card">
            <div class="gp-card-header">
                ...
                <h2 class="gp-card-title"><?php esc_html_e('Site Information', 'ghostseo-connector'); ?></h2>
            </div>

            <table class="gp-info-table">
                <tr>
                    <th><?php esc_html_e('Site Key', 'ghostseo-connector'); ?></th>
                    <td>
                        <span class="gp-secret-wrap">
                            <code class="gp-secret-value gp-blurred"><?php echo esc_html(GP_SITE_KEY); ?></code>
                            <button type="button" class="gp-secret-toggle" title="<?php esc_attr_e('Show/Hide', 'ghostseo-connector'); ?>">
                ...
                <tr>
                    <th><?php esc_html_e('Site ID', 'ghostseo-connector'); ?></th>
                    <td>
                        <span class="gp-secret-wrap">
                ...
                <tr>
                    <th><?php esc_html_e('API URL', 'ghostseo-connector'); ?></th>
                    <td><code><?php echo esc_html(GP_API_URL); ?></code></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Plugin', 'ghostseo-connector'); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e('WordPress', 'ghostseo-connector'); ?></th>
                    <td><?php echo esc_html(get_bloginfo('version')); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('PHP', 'ghostseo-connector'); ?></th>
        ...
        <div class="gp-card">
            <div class="gp-card-header">
                ...
                <h2 class="gp-card-title"><?php esc_html_e('Detected Plugins', 'ghostseo-connector'); ?></h2>
            </div>
            ...
            <ul class="gp-plugins-list">
                <li>
                    ...
                    <span class="gp-plugin-name"><?php esc_html_e('Yoast SEO', 'ghostseo-connector'); ?></span>
                    <?php if (defined('WPSEO_VERSION')): ?>
                        <span class="gp-plugin-version"><?php echo esc_html(WPSEO_VERSION); ?></span>
                    <?php else: ?>
                        <span class="gp-badge gp-badge-neutral"><?php esc_html_e('Not installed', 'ghostseo-connector'); ?></span>
                    <?php endif; ?>
                </li>
                <li>
                    <span class="gp-plugin-status <?php echo defined('RANK_MATH_VERSION') ? 'gp-plugin-active' : 'gp-plugin-inactive'; ?>"></span>
                    <span class="gp-plugin-name"><?php esc_html_e('Rank Math', 'ghostseo-connector'); ?></span>
                ...
                <li>
                    ...
                    <span class="gp-plugin-name"><?php esc_html_e('Advanced Custom Fields', 'ghostseo-connector'); ?></span>
            ...
            <?php if (!empty($detected_redir_plugins)): ?>
                <hr class="gp-divider">
                <p class="gp-section-label"><?php esc_html_e('Redirection Plugins', 'ghostseo-connector'); ?></p>
                <ul class="gp-plugins-list">
                    ...
                    <li>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=ghostseo&tab=redirections')); ?>" class="gp-btn gp-btn-secondary gp-btn-sm gp-plugin-action">
                            <?php esc_html_e('Manage', 'ghostseo-connector'); ?>
                        </a>
                    </li>
                    <?php endforeach; ?>
                </ul>
