...
export async function GET(request) {
  try {
    ...
    console.log('[Dashboard Stats] Results:', {
      ...
      gscConnected: integration.gscConnected,
      hasGA: !!resolved.ga,
      trafficChartLen: Array.isArray(resolved.trafficChart) ? resolved.trafficChart.length : 'null',
    ...
    return NextResponse.json({
      ...
      trafficChart: Array.isArray(resolved.trafficChart) ? resolved.trafficChart : [],
