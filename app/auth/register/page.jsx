...
export default async function RegisterPage({ searchParams }) {
  ...
  const translations = {
    ...
    payment: {
      ...
      phonePlaceholder: t('registration.payment.phonePlaceholder'),
      expMonth: t('registration.payment.expMonth'),
      expYear: t('registration.payment.expYear'),
      ...
      initializing: t('registration.payment.initializing'),
      confirmFailed: t('registration.payment.confirmFailed'),
      paymentFailed: t('registration.payment.paymentFailed'),
      paymentError: t('registration.payment.paymentError'),
      iframeError: t('registration.payment.iframeError'),
      ...
      subscriptionType: t('registration.payment.subscriptionType'),
      monthly: t('registration.payment.monthly'),
      planPrice: t('registration.payment.planPrice'),
      prorated: t('registration.payment.prorated'),
      ...
      coupon: {
        ...
        apply: t('registration.payment.coupon.apply'),
        remove: t('registration.payment.coupon.remove'),
        invalid: t('registration.payment.coupon.invalid'),
        error: t('registration.payment.coupon.error'),
        discount: t('registration.payment.coupon.discount'),
        bonuses: t('registration.payment.coupon.bonuses'),
        durationNote: t('registration.payment.coupon.durationNote'),
        usageLimit: t('registration.payment.coupon.usageLimit'),
        notActive: t('registration.payment.coupon.notActive'),
      ...
      limitations: {
        ...
        aiCredits: t('registration.payment.limitations.aiCredits'),
        maxPages: t('registration.payment.limitations.maxPages'),
        maxPosts: t('registration.payment.limitations.maxPosts'),
        siteAudits: t('registration.payment.limitations.siteAudits'),
      },
      features: {
        aiContentGeneration: t('registration.payment.features.aiContentGeneration'),
        prioritySupport: t('registration.payment.features.prioritySupport'),
        advancedAnalytics: t('registration.payment.features.advancedAnalytics'),
        seoOptimization: t('registration.payment.features.seoOptimization'),
      },
    },
    success: {
      ...
      <div className={styles.authCardWide}>
        ...
        <div className={styles.authHeader}>
          <div className={styles.authLogo}>
            <img src="/logo-light.svg" alt={translations.brandName} className={`${styles.authLogoMark} ${styles.authLogoLight}`} />
            <img src="/logo-dark.svg" alt={translations.brandName} className={`${styles.authLogoMark} ${styles.authLogoDark}`} />
          </div>
