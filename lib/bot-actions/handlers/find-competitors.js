...
Search for "${keyword}" and list the top 10 ACTUAL BUSINESS websites from the search results.${businessTypeContext}${websiteCharacterContext}
...
export async function findCompetitors(params, context) {
  ...
  try {
    ...
    for (const keyword of keywordsToSearch) {
      ...
      // Aggregate token usage across all keyword searches
    ...
    // Track AI credits usage with actual token counts
