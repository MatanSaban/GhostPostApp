 ...
 * Uses NEXT_PUBLIC_BASE_URL which should be set correctly per environment
 */
function getBaseUrl() {
  // NEXT_PUBLIC_BASE_URL should be set in Vercel env vars for production
  // and in .env for local development
