 ...
 */
async function generateCannibalizationFix({ pages, originalAction, reason, locale, accountId, siteId }) {
...
async function generateSeoForPage({ title, content, siteName, locale, accountId, siteId }) {
...
async function generateSeoForKeyword({ title, content, keyword, position, currentSeoTitle, currentSeoDesc, siteName, locale, accountId, siteId }) {
  const langInstruction = locale?.startsWith('he') ? 'Write in Hebrew.' : `Write in the language matching locale "${locale}".`;
...
async function generateSeoForCtrGap({ title, content, position, actualCtr, expectedCtr, currentSeoTitle, currentSeoDesc, siteName, locale, accountId, siteId }) {
  const langInstruction = locale?.startsWith('he') ? 'Write in Hebrew.' : `Write in the language matching locale "${locale}".`;
