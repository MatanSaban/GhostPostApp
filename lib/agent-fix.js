...
const FIXABLE_TYPES = new Set(['missingSeo', 'keywordStrikeZone', 'lowCtrForPosition', 'cannibalization', 'missingFeaturedImage', 'insufficientContentImages', 'aiPageMissingSchema', 'aiAnswerableButNotConcise']);
