              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:560px;margin:0 auto;">
                <tr><td style="text-align:center;padding-bottom:24px;">
                  <div style="display:inline-block;background:linear-gradient(135deg,#a855f7 0%,#7c3aed 50%,#6366f1 100%);padding:14px 22px;border-radius:12px;">
                    <span style="color:#fff;font-size:22px;font-weight:700;">Ghost Post</span>
                  </div>
                </td></tr>
                <tr><td style="background:linear-gradient(180deg,#1a1a24 0%,#12121a 100%);border-radius:16px;border:1px solid #2a2a3a;overflow:hidden;">
                  ...
                  <div style="padding:16px 32px;background:rgba(0,0,0,0.3);border-top:1px solid #2a2a3a;">
                    <p style="margin:0;color:#505060;font-size:12px;text-align:center;">You're receiving this because you opened a support ticket on Ghost Post.</p>
                  </div>
                </td></tr>
              </table>
            </td></tr>
            ...
            <tr><td style="padding:32px 20px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:560px;margin:0 auto;background:linear-gradient(180deg,#1a1a24 0%,#12121a 100%);border:1px solid #2a2a3a;border-radius:14px;overflow:hidden;">
                <tr><td style="padding:22px 28px;border-bottom:1px solid #2a2a3a;">
                  <p style="margin:0 0 4px;color:#a0a0b0;font-size:11px;font-family:monospace;text-transform:uppercase;letter-spacing:0.05em;">Ghost Post · Support · ${ticket.priority}</p>
