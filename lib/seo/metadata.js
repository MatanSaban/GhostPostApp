...
export const pageRegistry = {
  ...
  '/dashboard/strategy/backlinks': { titleKey: 'meta.dashboard.strategy.backlinks.title', descriptionKey: 'meta.dashboard.strategy.backlinks.description' },
...
export async function buildRootMetadata({ locale } = {}) {
  ...
  return {
    ...
    icons: siteConfig.icons,
    // PWA: iOS doesn't read manifest.webmanifest for home-screen behavior —
    // these tags are how Safari learns the app is installable.
    appleWebApp: {
      capable: true,
