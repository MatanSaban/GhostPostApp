// Centralized metadata system for the Ghost Post Platform.
//
...
export const siteConfig = {
  ...
  defaultDescription:
    'Automate your SEO strategy with Ghost Post. AI-powered content creation, optimization, and site management.',
  defaultKeywords: ['SEO', 'AI', 'automation', 'content', 'optimization', 'Ghost Post'],
  themeColor: '#7b2cbf',
  icons: {
...
// in one line. Reads the locale from the `ghost-post-locale` cookie and
